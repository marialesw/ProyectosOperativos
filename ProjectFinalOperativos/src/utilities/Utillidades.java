...
public class Utillidades {
	...
	public static void showMessageWarning(String mensaje, String title) {
		JOptionPane.showMessageDialog(null, mensaje, title, JOptionPane.WARNING_MESSAGE,new ImageIcon("D:\\asus\\Documents\\Programas SO\\S_O_Proyecto 7\\src\\img\\logoadmir.png"));
	}
	
	public static void showMessageInformation(String mensaje, String title) {
		JOptionPane.showMessageDialog(null, mensaje, title, JOptionPane.INFORMATION_MESSAGE,new ImageIcon("D:\\asus\\Documents\\Programas SO\\S_O_Proyecto 7\\src\\img\\logoadmir.png"));
	}

	public static void showMessageError(String mensaje, String title) {
		JOptionPane.showMessageDialog(null, mensaje, title, JOptionPane.ERROR_MESSAGE, new ImageIcon("D:\\asus\\Documents\\Programas SO\\S_O_Proyecto 7\\src\\img\\logoError.png"));
	}
